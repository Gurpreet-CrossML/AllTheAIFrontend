						...
						<form noValidate onSubmit={handleSubmit}>
							<Grid container spacing={3}>
								<Grid item xs={12} md={6}>
									<Stack spacing={1}>
										<InputLabel htmlFor="firstname-signup">First Name<span style={{ color: 'red' }}>*</span></InputLabel>
										<OutlinedInput
											id="firstname-login"
								...
								<Grid item xs={12} md={6}>
									<Stack spacing={1}>
										<InputLabel htmlFor="lastname-signup">Last Name<span style={{ color: 'red' }}>*</span></InputLabel>
										<OutlinedInput
											fullWidth
								...
								<Grid item xs={12}>
									<Stack spacing={1}>
										<InputLabel htmlFor="email-signup">Email Address<span style={{ color: 'red' }}>*</span></InputLabel>
										<OutlinedInput
											fullWidth
								...
								<Grid item xs={12}>
									<Stack spacing={1}>
										<InputLabel htmlFor="password-signup">Password<span style={{ color: 'red' }}>*</span></InputLabel>
										<OutlinedInput
											fullWidth
								...
								<Grid item xs={12}>
									<Stack spacing={1}>
										<InputLabel htmlFor="confirm-password-signup">Confirm Password<span style={{ color: 'red' }}>*</span></InputLabel>
										<OutlinedInput
											fullWidth
