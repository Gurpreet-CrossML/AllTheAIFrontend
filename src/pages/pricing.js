    ...
    <>
      ...
      <Grid container spacing={1} marginTop={2}>
          ...
          <Grid container spacing={2}>
            {plansList?.length > 0 && plansList.map((item, index) => {
              return (
                      ...
                      <Grid item xs={12}>
                        ...
                        >
                          ...
                          <LoadingButton
                            ...
                            onClick={() => {
                              Number(item.price) < Number(activatePlan?.plan_details?.price) ? handleConfirmModalOpen(item, index) : handleModal(item, index)
                            }}
                            fullWidth={(item.id === activatePlan?.billing_plan) && true}
                            style={{
                              pointerEvents: (item.id === activatePlan?.billing_plan) ? "none" : "", color: item.id === activatePlan?.billing_plan ?"#7265E6" : "#fff",
                              backgroundColor: item.id === activatePlan?.billing_plan
                            ...
                            borderColor: item.id === activatePlan?.billing_plan
